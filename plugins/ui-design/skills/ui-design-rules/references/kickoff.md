...
4. Show the user the screenshot and ask for two picks: a number (palette) and a letter (pairing). Offer "take the default" — the first candidate is always the safe one.
